    ...
    2: [
      function (require, module, exports) {
        ...
        function formatTimes({ allDay, startUtc, endUtc }, dateTimeFormat) {
          const format =
            utils_1.TimeFormats[allDay ? "allDay" : dateTimeFormat];
        ...
        const google = (calendarEvent) => {
          ...
          return `https://calendar.google.com/calendar/render?${query_string_1.stringify(
            details
          )}`;
        };
        ...
        const outlook = (calendarEvent) => {
          ...
          return `https://outlook.live.com/calendar/0/deeplink/compose?${query_string_1.stringify(
            details
          )}`;
        };
        ...
        const office365 = (calendarEvent) => {
          ...
          return `https://outlook.office.com/calendar/0/deeplink/compose?${query_string_1.stringify(
            details
          )}`;
        };
        ...
        const yahoo = (calendarEvent) => {
          ...
          return `https://calendar.yahoo.com/?${query_string_1.stringify(
            details
          )}`;
        };
        exports.yahoo = yahoo;
      ...
      { "./utils": 3, dayjs: 4, "dayjs/plugin/utc": 5, "query-string": 8 },
    ],
    3: [
      function (require, module, exports) {
        "use strict";
